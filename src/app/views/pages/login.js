...
var LoginForm2 = require('../component/loginfrom2.js');
...
var loginPage = React.createClass({
    ...
    componentDidMount: function() {
        if(document.getElementById('loginPage') != null) {
            document.getElementById('loginPage').style.height = $(window).height() + 'px';
        };
    },
    ...
    render : function(){
        ...
        return(
            <div id="loginPage" className="loginPage">
                <SelectRoleModal onComfirmClick={this.handleComfirmOnClick} onCancelClick={this.handleCancelOnClick}/>
                <LoginForm2 onLoginClick={e => this.handleLoginOnClick(e)} errorMsg={errorMsg}/>
            </div>
        );
    }
});
