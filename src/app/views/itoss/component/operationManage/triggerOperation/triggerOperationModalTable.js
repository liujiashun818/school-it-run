...
var monitorInfo = React.createClass({
  ...
  onDeleteInfo:function(){
    ...
    this.props.set_handleAssets(handleAssets);
    this.onResetForm();
  ...
  componentDidUpdate:function(){
      const { assets, isBunder } = this.props;
    // var assets = this.state.itoss.assets;
    if(assets.length<=0){
      dataUniqList = [];
      dataValueList = [];
      handleAssets = [];
    ...
    // var isBunder = this.state.itoss.isBunder;
  ...
  componentDidMount:function(){
    const { assets, change_isBunder } = this.props;
    var that = this;
    setTimeout(function(){
      dataUniqList = [];
      dataValueList = [];
...
monitorInfo.propTypes = {
    ...
    set_handleAssets: PropTypes.func.isRequired,
    change_isBunder: PropTypes.func.isRequired,
    get_Assets: PropTypes.func.isRequired
};
