      ...
      return(
        <div id='editOperation' className='overviewDiv'>
          ...
          <OperationForm
            ...
            setCurName={data => dispatch(setCurName(data))}
            workOrderTemplatesMainForm={this.props.workOrderTemplatesMainForm} workOrderTemplatesSheetForm={this.props.workOrderTemplatesSheetForm}
            getBusObDefFieldsDetail={param =>dispatch(operationAction.getBusObDefFieldsDetail(param))} getBusObDefFieldsHandle={param =>dispatch(operationAction.getBusObDefFieldsHandle(param))}
            busObDefFieldDetail={this.props.busObDefFieldDetail} busObDefFieldHandle={this.props.busObDefFieldHandle}
            workOrderTemplatesMainData={this.props.workOrderTemplatesMainData} workOrderTemplatesSheetData={this.props.workOrderTemplatesSheetData}
            workFlowDetailCurrent={this.props.workFlowDetailCurrent}
            get_workOrderTemplatesSheetFromId={param =>dispatch(operationAction.get_workOrderTemplatesSheetFromId(param))}
            save_updateDetailTemplate={(detailData, entity) =>dispatch(operationAction.save_updateDetailTemplate(detailData, entity))}
            add_WorkFlowLogDataAndHandleTemplate={(data, handleData, entity) =>dispatch(operationflowAction.add_WorkFlowLogDataAndHandleTemplate(data, handleData, entity))}
          />
        </div>
      );
    }
...
function mapEditOperationState(state) {
  ...
  const { workFlowTypes,curWorkFlowId,orderDetailData,permissions,curWorkOrderId,serviceData,faultTypes,
          faultSubTypes,serviceName,assets,curWorkOrderStatus,
          delayIndex,flowPicData,faultTypeId,faultSubTypeId,serviceId,curDelayId,
          workFlowDetailCurrent,workOrderTemplatesMainForm,workOrderTemplatesSheetForm,busObDefFieldDetail,busObDefFieldHandle,
          workOrderTemplatesMainData,workOrderTemplatesSheetData
