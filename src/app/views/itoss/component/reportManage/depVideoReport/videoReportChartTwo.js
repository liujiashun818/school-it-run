    ...
    _getDailyReportChart: function() {
      ...
      switch (chartId) {
          ...
          case "videoQuarterlyReportChartTwo":
              ...
              break;
          case "videoYearlyReportChartTwo":
...
var VideoCheckCustomChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      //自己定义取数据条件
      //var customParam = this.state.report.videoCheckCustomParam;
