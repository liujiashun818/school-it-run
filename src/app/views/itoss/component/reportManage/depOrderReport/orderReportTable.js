...
var DepOrderReportTableTemp = React.createClass({
    // mixins: [FluxMixin, StoreWatchMixin("ReportManageStore")],
    // getStateFromFlux: function() {
    //     var flux = this.getFlux();
    //     return {
    ...
    componentDidUpdate: function() {
        //更新table
        var chartKey = this.props.chartKey;
        var chartMark = this.props.chartDataMark;
        var that = this;
        var datas = [];
        var datas1 = this.props.orderOnceData;
        var datas2 = this.props.orderTwiceData;
        var datas3 = this.props.orderTreeData;
        if(chartMark == 1){
          datas = datas1;
        }else if(chartMark == 2){
          datas = datas2;
...
DepOrderReportTableTemp.propTypes = {
    tableId: PropTypes.string.isRequired,
    chartKey: PropTypes.number.isRequired,
    chartDataMark: PropTypes.string.isRequired,
...
module.exports = {
  ...
  DepOrderReportTable: DepOrderReportTableTemp
};
