...
var NVRStatisticsReport = React.createClass({
    render: function() {
        const { dispatch, nvrStorageDailyData, nvrStorageWeeklyData, nvrStorageMonthlyData, nvrStorageQuarterlyData, nvrStorageYearlyData, nvrStorageCustomData, nvrStorageCustomLineData, curThreeNode, preThreeNode } = this.props;
        return (
            <div className='overviewDiv'>
                <NonVideoLeftList activeMenu={2} curName={this.props.curName} setCurName={data => dispatch(navbarActions.setCurName(data))} curThreeNode={curThreeNode} preThreeNode={preThreeNode} onGetCurThreeNode={curNode => dispatch(navbarActions.setCurThreeNode(curNode))} onGetPreThreeNode={curNode => dispatch(navbarActions.setPreThreeNode(curNode))}/>
                <NVRStatisticsReportView nvrStorageDailyData={nvrStorageDailyData} nvrStorageWeeklyData={nvrStorageWeeklyData} nvrStorageMonthlyData={nvrStorageMonthlyData}
                    nvrStorageQuarterlyData={nvrStorageQuarterlyData} nvrStorageYearlyData={nvrStorageYearlyData} nvrStorageCustomData={nvrStorageCustomData} nvrStorageCustomLineData={nvrStorageCustomLineData}
...
function mapStateToProps(state) {
  const { nvrStorageDailyData, nvrStorageWeeklyData, nvrStorageMonthlyData, nvrStorageQuarterlyData, nvrStorageYearlyData, nvrStorageCustomData, nvrStorageCustomLineData } = state.reportManageReducer
