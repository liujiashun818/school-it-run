/**
 * Created by xinnang.zhang on 2016/02/19.
 */
require('bootstrap');
...
var DVRReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var data = chartData;
      var option = Util.getTingJiView("DVR",data,chartTitle);
      switch (chartId) {
...
var DVRCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "DVR统计报表";
      var option = Util.getTingJiCustomView("DVR",customData,chartTitle);
...
var NVRReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var data = chartData;
      var option = Util.getTingJiView("NVR",data,chartTitle);
...
var NVRCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "NVR统计报表";
      var option = Util.getTingJiCustomView("NVR",customData,chartTitle);
...
var EncoderReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var data = chartData;
      var option = Util.getTingJiView("编码器",data,chartTitle);
      switch (chartId) {
...
var EncoderCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "编码器统计报表";
      var option = Util.getTingJiCustomView("编码器",customData,chartTitle);
...
var ServerReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var data = chartData;
      var option = Util.getTingJiView("服务器",data,chartTitle);
      switch (chartId) {
...
var ServerCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "服务器统计报表";
      var option = Util.getTingJiCustomView("服务器",customData,chartTitle);
...
var NetworkReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var data = chartData;
      var option = Util.getTingJiView("网络设备",data,chartTitle);
      switch (chartId) {
...
var NetworkCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "网络设备统计报表";
      var option = Util.getTingJiCustomView("网络设备",customData,chartTitle);
...
var FirewallReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var data = chartData;
      var option = Util.getTingJiView("防火墙",data,chartTitle);
      switch (chartId) {
...
var FirewallCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "防火墙统计报表";
      var option = Util.getTingJiCustomView("防火墙",customData,chartTitle);
...
var DatabaseReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var data = chartData;
      var option = Util.getTingJiView("数据库",data,chartTitle);
      switch (chartId) {
...
var DatabaseCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "数据库统计报表";
      var option = Util.getTingJiCustomView("数据库",customData,chartTitle);
