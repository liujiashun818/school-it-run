...
var DVRCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "DVR统计报表";
      var option = Util.getXianShiJiCustomView("DVR",customData,chartTitle);
...
var NVRCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "NVR统计报表";
      var option = Util.getXianShiJiCustomView("NVR",customData,chartTitle);
    ...
    _getDailyReportChart: function() {
      ...
      switch (chartId) {
          ...
          case "encoderMonthlyReportChartThree":
              ...
              break;
          case "encoderQuarterlyReportChartThree":
              ...
              break;
          case "encoderYearlyReportChartThree":
...
var EncoderCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "编码器统计报表";
      var option = Util.getXianShiJiCustomView("编码器",customData,chartTitle);
    ...
    _getDailyReportChart: function() {
      ...
      switch (chartId) {
          ...
          case "serverQuarterlyReportChartThree":
              ...
              break;
          case "serverYearlyReportChartThree":
...
var ServerCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "服务器统计报表";
      var option = Util.getXianShiJiCustomView("服务器",customData,chartTitle);
    ...
    _getDailyReportChart: function() {
      ...
      switch (chartId) {
          ...
          case "networkMonthlyReportChartThree":
              ...
              break;
          case "networkQuarterlyReportChartThree":
              ...
              break;
          case "networkYearlyReportChartThree":
...
var NetworkCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "网络设备统计报表";
      var option = Util.getXianShiJiCustomView("网络设备",customData,chartTitle);
...
var FirewallReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var data = chartData;
      var option =  Util.getXianShiJiView("防火墙",data,chartTitle);
      switch (chartId) {
          case "firewallDailyReportChartThree":
              firewallDailyReportChart = echarts.init(document.getElementById(chartId), 'macarons');
              firewallDailyReportChart.setOption(option);
              break;
          case "firewallWeeklyReportChartThree":
              ...
              break;
          case "firewallMonthlyReportChartThree":
              ...
              break;
          case "firewallQuarterlyReportChartThree":
              ...
              break;
          case "firewallYearlyReportChartThree":
...
var FirewallCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "防火墙统计报表";
      var option = Util.getXianShiJiCustomView("防火墙",customData,chartTitle);
...
var DatabaseReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var data = chartData;
      var option =  Util.getXianShiJiView("数据库",data,chartTitle);
      switch (chartId) {
          case "databaseDailyReportChartThree":
              databaseDailyReportChart = echarts.init(document.getElementById(chartId), 'macarons');
              databaseDailyReportChart.setOption(option);
              break;
          case "databaseWeeklyReportChartThree":
              ...
              break;
          case "databaseMonthlyReportChartThree":
              ...
              break;
          case "databaseQuarterlyReportChartThree":
              ...
              break;
          case "databaseYearlyReportChartThree":
...
var DatabaseCustomReportChart = React.createClass({
    ...
    _getDailyReportChart: function() {
      ...
      var chartTitle = "数据库统计报表";
      var option = Util.getXianShiJiCustomView("数据库",customData,chartTitle);
