...
// var VideoReportChart = require('./videoReportChart').VideoLossChart;
var VideoReportTable = require('./VideoReportTable').VideoLossReportTable;
...
var CameraVideoLostStatisticsReportView = React.createClass({
    ...
    componentDidMount: function() {
      ...
      if (this.isMounted()) {
        if($('#videoLossReport') != null) {
          var height = $(window).height() - 110 - 30 + 'px';
    			$('#videoLossReport').css("height",height);
    		}
    ...
    _getCheckData: function(par){
      ...
      switch (par.key) {
        case 1:
          type = 'videoImageLossDetailsDaily'
          break;
        case 2:
          type = 'videoImageLossDetailsWeekly'
          break;
        case 3:
          type = 'videoImageLossDetailsMonthly'
          break;
        case 4:
          type = 'videoImageLossDetailsQuarterly'
          break;
        case 5:
          type = 'videoImageLossDetailsYearly'
          break;
        case 6:
          type = 'videoImageLossDetailsDaily'
          break;
    ...
    render: function() {
      const { videoLossDailyData, videoLossWeeklyData, videoLossMonthlyData, videoLossQuarterlyData, videoLossYearlyData, videoLossCustomData } = this.props;
      return (
        <div id="videoLossReport" className='overviewDesViewDiv assetDesViewDiv'>
          <div className="titleDiv col-md-12">
              <div className="titleLeft">报表：摄像机视频丢失详细统计</div>
                ...
                <div className="contentDiv tab-content marginleft_none">
                    <div className="tab-pane active" id="tab_1">
                      ...
                      <div className="re-table">
                        <VideoReportTable tableId="cameraLossDailyReportTable" chartKey={this.state.tabsState} videoLossDailyData={videoLossDailyData} videoLossWeeklyData={videoLossWeeklyData}
                            videoLossMonthlyData={videoLossMonthlyData} videoLossQuarterlyData={videoLossQuarterlyData} videoLossYearlyData={videoLossYearlyData} videoLossCustomData={videoLossCustomData}/>
                      </div>
                    </div>
                    <div className="tab-pane" id="tab_2">
                      ...
                      <div className="re-table">
                        <VideoReportTable tableId="cameraLossWeeklyReportTable" chartKey={this.state.tabsState} videoLossDailyData={videoLossDailyData} videoLossWeeklyData={videoLossWeeklyData}
                            videoLossMonthlyData={videoLossMonthlyData} videoLossQuarterlyData={videoLossQuarterlyData} videoLossYearlyData={videoLossYearlyData} videoLossCustomData={videoLossCustomData}/>
                      </div>
                    </div>
                    <div className="tab-pane" id="tab_3">
                      ...
                      <div className="re-table">
                        <VideoReportTable tableId="cameraLossMonthlyReportTable" chartKey={this.state.tabsState} videoLossDailyData={videoLossDailyData} videoLossWeeklyData={videoLossWeeklyData}
                            videoLossMonthlyData={videoLossMonthlyData} videoLossQuarterlyData={videoLossQuarterlyData} videoLossYearlyData={videoLossYearlyData} videoLossCustomData={videoLossCustomData}/>
                      </div>
                    </div>
                    <div className="tab-pane" id="tab_4">
                      ...
                      <div className="re-table">
                        <VideoReportTable tableId="cameraLossQuarterlyReportTable" chartKey={this.state.tabsState} videoLossDailyData={videoLossDailyData} videoLossWeeklyData={videoLossWeeklyData}
                            videoLossMonthlyData={videoLossMonthlyData} videoLossQuarterlyData={videoLossQuarterlyData} videoLossYearlyData={videoLossYearlyData} videoLossCustomData={videoLossCustomData}/>
                      </div>
                    </div>
                    <div className="tab-pane" id="tab_5">
                      ...
                      <div className="re-table">
                        <VideoReportTable tableId="cameraLossYearlyReportTable" chartKey={this.state.tabsState} videoLossDailyData={videoLossDailyData} videoLossWeeklyData={videoLossWeeklyData}
                            videoLossMonthlyData={videoLossMonthlyData} videoLossQuarterlyData={videoLossQuarterlyData} videoLossYearlyData={videoLossYearlyData} videoLossCustomData={videoLossCustomData}/>
                      </div>
                    </div>
                    <div className="tab-pane" id="tab_6">
                      ...
                      <div className="re-table">
                        <VideoReportTable tableId="cameraLossCustomReportTable" chartKey={this.state.tabsState} videoLossDailyData={videoLossDailyData} videoLossWeeklyData={videoLossWeeklyData}
                            videoLossMonthlyData={videoLossMonthlyData} videoLossQuarterlyData={videoLossQuarterlyData} videoLossYearlyData={videoLossYearlyData} videoLossCustomData={videoLossCustomData}/>
                      </div>
                    </div>
                </div>
