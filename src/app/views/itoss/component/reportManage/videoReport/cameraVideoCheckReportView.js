...
var CameraVideoCheckReportView = React.createClass({
  ...
  // },
    ...
    _getCheckData: function(par){
      ...
      var tabsState = curvideochecktabsState;
      switch (key) {
        case 1:
          type = 'videoDaily'
          break;
    ...
    render: function() {
      const { videoCheckDailyData, videoCheckWeeklyData, videoCheckMonthlyData, videoCheckQuarterlyData, videoCheckYearlyData, videoCheckCustomData } = this.props;
      return (
                ...
                <div className="contentDiv tab-content marginleft_none">
                    ...
                    <div className="tab-pane" id="tab_6">
                      ...
                      <div className="re-chart col-md-12">
                        <VideoCheckCustomChart chartId="videoCustomReportChart" chartKey={this.state.customOption} videoCheckCustomData={videoCheckCustomData}/>
                      </div>
