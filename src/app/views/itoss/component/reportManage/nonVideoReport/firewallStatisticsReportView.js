...
var FirewallStatisticsReportView = React.createClass({
    ...
    _getCheckData: function(par){
        ...
        var tabsState = curfirewalltabsState;
        switch (key) {
            case 1:
                type = 'serverDaily'
                break;
    ...
    render: function() {
        const { firewallDailyData, firewallWeeklyData, firewallMonthlyData, firewallQuarterlyData, firewallYearlyData, firewallCustomData } = this.props;
        return (
                            ...
                            <div className="contentDiv tab-content marginleft_none">
                                <div className="tab-pane active" id="tab_1">
                                    ...
                                    <div className="re-chart">
                                        <FirewallReportChart chartId="firewallDailyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                    ...
                                    <div className="re-table">
                                        <FirewallReportTable tableId="firewallDailyReportTable" chartKey={this.state.tabsState} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_2">
                                    ...
                                    <div className="re-chart">
                                        <FirewallReportChart chartId="firewallWeeklyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                    <div className="re-table">
                                        <FirewallReportTable tableId="firewallWeeklyReportTable" chartKey={this.state.tabsState} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_3">
                                    ...
                                    <div className="re-chart">
                                        <FirewallReportChart chartId="firewallMonthlyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                    <div className="re-table">
                                        <FirewallReportTable tableId="firewallMonthlyReportTable" chartKey={this.state.tabsState} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_4">
                                    ...
                                    <div className="re-chart">
                                        <FirewallReportChart chartId="firewallQuarterlyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                    <div className="re-table">
                                        <FirewallReportTable tableId="firewallQuarterlyReportTable" chartKey={this.state.tabsState} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_5">
                                    ...
                                    <div className="re-chart">
                                        <FirewallReportChart chartId="firewallYearlyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                    <div className="re-table">
                                        <FirewallReportTable tableId="firewallYearlyReportTable" chartKey={this.state.tabsState} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_6">
                                    ...
                                    <div className="re-chart col-md-12">
                                        <FirewallCustomReportChart chartId="firewallCustomReportChart" chartKey={this.state.tabsState} firewallCustomData={firewallCustomData}/>
                                    </div>
                                    <div className="re-table col-md-12">
                                        <FirewallReportTable tableId="firewallCustomReportTable" chartKey={this.state.tabsState} firewallDailyData={firewallDailyData} firewallWeeklyData={firewallWeeklyData}
                                            firewallMonthlyData={firewallMonthlyData} firewallQuarterlyData={firewallQuarterlyData} firewallYearlyData={firewallYearlyData} firewallCustomData={firewallCustomData}/>
                                    </div>
                                </div>
                            </div>
