...
var DatabaseStatisticsReportView = React.createClass({
    ...
    _getCheckData: function(par){
        ...
        var tabsState = curdatabasetabsState;
        switch (key) {
            case 1:
                type = 'serverDaily'
                break;
    ...
    render: function() {
        const { databaseDailyData, databaseWeeklyData, databaseMonthlyData, databaseQuarterlyData, databaseYearlyData, databaseCustomData } = this.props;
        return (
                            ...
                            <div className="contentDiv tab-content marginleft_none">
                                <div className="tab-pane active" id="tab_1">
                                    ...
                                    <div className="re-chart">
                                        <DatabaseReportChart chartId="databaseDailyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                    ...
                                    <div className="re-table">
                                        <DatabaseReportTable tableId="databaseDailyReportTable" chartKey={this.state.tabsState} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_2">
                                    ...
                                    <div className="re-chart">
                                        <DatabaseReportChart chartId="databaseWeeklyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                    <div className="re-table">
                                        <DatabaseReportTable tableId="databaseWeeklyReportTable" chartKey={this.state.tabsState} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_3">
                                    ...
                                    <div className="re-chart">
                                        <DatabaseReportChart chartId="databaseMonthlyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                    <div className="re-table">
                                        <DatabaseReportTable tableId="databaseMonthlyReportTable" chartKey={this.state.tabsState} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_4">
                                    ...
                                    <div className="re-chart">
                                        <DatabaseReportChart chartId="databaseQuarterlyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                    <div className="re-table">
                                        <DatabaseReportTable tableId="databaseQuarterlyReportTable" chartKey={this.state.tabsState} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_5">
                                    ...
                                    <div className="re-chart">
                                        <DatabaseReportChart chartId="databaseYearlyReportChart" chartKey={this.state.tabsState} reportdate={this.state.initdate} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                    <div className="re-table">
                                        <DatabaseReportTable tableId="databaseYearlyReportTable" chartKey={this.state.tabsState} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                </div>
                                <div className="tab-pane" id="tab_6">
                                    ...
                                    <div className="re-chart col-md-12">
                                        <DatabaseCustomReportChart chartId="databaseCustomReportChart" chartKey={this.state.tabsState} databaseCustomData={databaseCustomData}/>
                                    </div>
                                    <div className="re-table col-md-12">
                                        <DatabaseReportTable tableId="databaseCustomReportTable" chartKey={this.state.tabsState} databaseDailyData={databaseDailyData} databaseWeeklyData={databaseWeeklyData}
                                            databaseMonthlyData={databaseMonthlyData} databaseQuarterlyData={databaseQuarterlyData} databaseYearlyData={databaseYearlyData} databaseCustomData={databaseCustomData}/>
                                    </div>
                                </div>
                            </div>
