...
var NVRStatisticsReportView = React.createClass({
    ...
    render: function() {
        const { nvrStorageDailyData, nvrStorageWeeklyData, nvrStorageMonthlyData, nvrStorageQuarterlyData, nvrStorageYearlyData, nvrStorageCustomData } = this.props;
        return (
                            ...
                            <div className="contentDiv tab-content marginleft_none">
                                ...
                                <div className="tab-pane" id="tab_6">
                                    ...
                                    <div className="re-chart col-md-12">
                                        <NVRCustomReportChart chartId="nvrCustomReportChart" chartKey={this.state.tabsState} nvrStorageCustomData={nvrStorageCustomData}/>
                                    </div>
