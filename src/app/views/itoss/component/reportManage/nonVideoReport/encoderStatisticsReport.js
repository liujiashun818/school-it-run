...
var EncoderStatisticsReport = React.createClass({
    render: function() {
        const { dispatch, encoderStorageDailyData, encoderStorageWeeklyData, encoderStorageMonthlyData, encoderStorageQuarterlyData, encoderStorageYearlyData, encoderStorageCustomData, curThreeNode, preThreeNode } = this.props;
        return (
            <div className='overviewDiv'>
                ...
                <EncoderStatisticsReportView encoderStorageDailyData={encoderStorageDailyData} encoderStorageWeeklyData={encoderStorageWeeklyData} encoderStorageMonthlyData={encoderStorageMonthlyData}
                    encoderStorageQuarterlyData={encoderStorageQuarterlyData} encoderStorageYearlyData={encoderStorageYearlyData} encoderStorageCustomData={encoderStorageCustomData}
...
function mapStateToProps(state) {
  const { encoderStorageDailyData, encoderStorageWeeklyData, encoderStorageMonthlyData, encoderStorageQuarterlyData, encoderStorageYearlyData, encoderStorageCustomData } = state.reportManageReducer
