...
var MonitoringSettingTab = require('./createResourceView_APC_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_APC = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_APC') != null) {
            document.getElementById('createResourceView_APC').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_APC" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_APC;
CreateResourceView_APC.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_APC)
