...
var MonitoringSettingTab = require('./createResourceView_SNMPWindows_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_SNMPWindows = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_SNMPWindows') != null) {
            document.getElementById('createResourceView_SNMPWindows').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_SNMPWindows" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_SNMPWindows;
CreateResourceView_SNMPWindows.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_SNMPWindows)
