...
var MonitoringSettingTab = require('./createResourceView_URL_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_URL = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_URL') != null) {
            document.getElementById('createResourceView_URL').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_URL" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_URL;
CreateResourceView_URL.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_URL)
