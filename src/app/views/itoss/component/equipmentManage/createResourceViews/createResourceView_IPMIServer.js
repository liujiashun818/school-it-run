...
var MonitoringSettingTab = require('./createResourceView_IPMIServer_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_IPMIServer = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_IPMIServer') != null) {
            document.getElementById('createResourceView_IPMIServer').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_IPMIServer" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_IPMIServer;
CreateResourceView_IPMIServer.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_IPMIServer)
