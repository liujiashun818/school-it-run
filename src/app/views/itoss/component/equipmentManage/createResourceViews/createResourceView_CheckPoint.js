...
var MonitoringSettingTab = require('./createResourceView_CheckPoint_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_CheckPoint = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_CheckPoint') != null) {
            document.getElementById('createResourceView_CheckPoint').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_CheckPoint" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_CheckPoint;
CreateResourceView_CheckPoint.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_CheckPoint)
