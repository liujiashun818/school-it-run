...
var MonitoringSettingTab = require('./createResourceView_Oracle_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Oracle = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Oracle') != null) {
            document.getElementById('createResourceView_Oracle').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Oracle" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Oracle;
CreateResourceView_Oracle.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Oracle)
