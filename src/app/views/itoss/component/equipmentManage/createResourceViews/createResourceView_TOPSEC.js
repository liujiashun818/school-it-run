...
var MonitoringSettingTab = require('./createResourceView_TOPSEC_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_TOPSEC = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_TOPSEC') != null) {
            document.getElementById('createResourceView_TOPSEC').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_TOPSEC" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_TOPSEC;
CreateResourceView_TOPSEC.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_TOPSEC)
