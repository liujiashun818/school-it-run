...
var MonitoringSettingTab = require('./createResourceView_EMCStorage_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_EMCStorage = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_EMCStorage') != null) {
            document.getElementById('createResourceView_EMCStorage').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_EMCStorage" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_EMCStorage;
CreateResourceView_EMCStorage.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_EMCStorage)
