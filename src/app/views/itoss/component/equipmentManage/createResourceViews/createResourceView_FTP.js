...
var MonitoringSettingTab = require('./createResourceView_FTP_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_FTP = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_FTP') != null) {
            document.getElementById('createResourceView_FTP').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_FTP" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_FTP;
CreateResourceView_FTP.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_FTP)
