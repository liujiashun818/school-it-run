...
var MonitoringSettingTab = require('./createResourceView_Santakups_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Santakups = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Santakups') != null) {
            document.getElementById('createResourceView_Santakups').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Santakups" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Santakups;
CreateResourceView_Santakups.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Santakups)
