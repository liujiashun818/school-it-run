...
var MonitoringSettingTab = require('./createResourceView_PIX_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_PIX = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_PIX') != null) {
            document.getElementById('createResourceView_PIX').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_PIX" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_PIX;
CreateResourceView_PIX.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_PIX)
