...
var MonitoringSettingTab = require('./createResourceView_LiebertCorp_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_LiebertCorp = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_LiebertCorp') != null) {
            document.getElementById('createResourceView_LiebertCorp').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_LiebertCorp" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_LiebertCorp;
CreateResourceView_LiebertCorp.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_LiebertCorp)
