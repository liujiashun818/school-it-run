...
var MonitoringSettingTab = require('./createResourceView_Mysql_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Mysql = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Mysql') != null) {
            document.getElementById('createResourceView_Mysql').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Mysql" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Mysql;
CreateResourceView_Mysql.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Mysql)
