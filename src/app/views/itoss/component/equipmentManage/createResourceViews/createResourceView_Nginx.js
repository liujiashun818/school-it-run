...
var MonitoringSettingTab = require('./createResourceView_Nginx_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Nginx = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Nginx') != null) {
            document.getElementById('createResourceView_Nginx').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Nginx" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Nginx;
CreateResourceView_Nginx.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Nginx)
