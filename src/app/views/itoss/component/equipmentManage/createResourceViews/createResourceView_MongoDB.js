...
var MonitoringSettingTab = require('./createResourceView_MongoDB_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_MongoDB = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_MongoDB') != null) {
            document.getElementById('createResourceView_MongoDB').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_MongoDB" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_MongoDB;
CreateResourceView_MongoDB.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_MongoDB)
