...
var MonitoringSettingTab = require('./createResourceView_WirelessNetwork_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_WirelessNetwork = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_WirelessNetwork') != null) {
            document.getElementById('createResourceView_WirelessNetwork').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_WirelessNetwork" className="overviewDesViewDiv operationButtons">
                <div className="titleDiv col-md-12">
                    <div className="titleLeft">
                        {this.props.resource.EqName}
                    </div>
...
// module.exports = CreateResourceView_WirelessNetwork;
CreateResourceView_WirelessNetwork.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_WirelessNetwork)
