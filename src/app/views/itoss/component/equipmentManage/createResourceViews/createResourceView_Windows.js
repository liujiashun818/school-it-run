...
var MonitoringSettingTab = require('./createResourceView_Windows_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Windows = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Windows') != null) {
            document.getElementById('createResourceView_Windows').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Windows" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Windows;
CreateResourceView_Windows.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Windows)
