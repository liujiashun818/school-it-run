...
var MonitoringSettingTab = require('./createResourceView_Network_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Network = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Network') != null) {
            document.getElementById('createResourceView_Network').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Network" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Network;
CreateResourceView_Network.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Network)
