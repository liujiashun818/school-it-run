...
var MonitoringSettingTab = require('./createResourceView_SyBase_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_SyBase = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_SyBase') != null) {
            document.getElementById('createResourceView_SyBase').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_SyBase" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_SyBase;
CreateResourceView_SyBase.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_SyBase)
