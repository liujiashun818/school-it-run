...
var MonitoringSettingTab = require('./createResourceView_Apache_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Apache = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Apache') != null) {
            document.getElementById('createResourceView_Apache').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Apache" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Apache;
CreateResourceView_Apache.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Apache)
