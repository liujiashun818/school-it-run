...
var MonitoringSettingTab = require('./createResourceView_Raritan_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Raritan = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Raritan') != null) {
            document.getElementById('createResourceView_Raritan').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Raritan" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Raritan;
CreateResourceView_Raritan.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Raritan)
