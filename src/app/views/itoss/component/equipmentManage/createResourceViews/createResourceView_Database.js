...
var MonitoringSettingTab = require('./createResourceView_Database_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Database = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Database') != null) {
            document.getElementById('createResourceView_Database').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Database" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Database;
CreateResourceView_Database.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Database)
