...
var MonitoringSettingTab = require('./createResourceView_FireWall_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Firewall = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Firewall') != null) {
            document.getElementById('createResourceView_Firewall').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Firewall" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Firewall;
CreateResourceView_Firewall.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Firewall)
