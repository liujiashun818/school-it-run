...
var MonitoringSettingTab = require('./createResourceView_APEM6100_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_APEM6100 = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_APEM6100') != null) {
            document.getElementById('createResourceView_APEM6100').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_APEM6100" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_APEM6100;
CreateResourceView_APEM6100.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_APEM6100)
