...
var MonitoringSettingTab = require('./createResourceView_Tomcat_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Tomcat = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Tomcat') != null) {
            document.getElementById('createResourceView_Tomcat').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Tomcat" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Tomcat;
CreateResourceView_Tomcat.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Tomcat)
