...
var MonitoringSettingTab = require('./createResourceView_F5BigIp_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_F5BigIp = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_F5BigIp') != null) {
            document.getElementById('createResourceView_F5BigIp').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_F5BigIp" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_F5BigIp;
CreateResourceView_F5BigIp.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_F5BigIp)
