...
var MonitoringSettingTab = require('./createResourceView_Emerson_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Emerson = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Emerson') != null) {
            document.getElementById('createResourceView_Emerson').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Emerson" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Emerson;
CreateResourceView_Emerson.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Emerson)
