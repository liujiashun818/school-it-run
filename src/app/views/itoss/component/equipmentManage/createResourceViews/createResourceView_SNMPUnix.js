...
var MonitoringSettingTab = require('./createResourceView_SNMPUnix_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_SNMPUnix = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_SNMPUnix') != null) {
            document.getElementById('createResourceView_SNMPUnix').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_SNMPUnix" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_SNMPUnix;
CreateResourceView_SNMPUnix.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_SNMPUnix)
