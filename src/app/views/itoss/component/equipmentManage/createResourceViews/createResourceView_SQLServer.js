...
var MonitoringSettingTab = require('./createResourceView_SqlServer_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_SqlServer = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_SqlServer') != null) {
            document.getElementById('createResourceView_SqlServer').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_SqlServer" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_SqlServer;
CreateResourceView_SqlServer.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_SqlServer)
