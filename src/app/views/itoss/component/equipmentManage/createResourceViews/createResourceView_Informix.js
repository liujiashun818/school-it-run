...
var MonitoringSettingTab = require('./createResourceView_Informix_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Informix = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Informix') != null) {
            document.getElementById('createResourceView_Informix').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Informix" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Informix;
CreateResourceView_Informix.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Informix)
