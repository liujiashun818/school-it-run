...
var MonitoringSettingTab = require('./createResourceView_IBMStorage_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_IBMStorage = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_IBMStorage') != null) {
            document.getElementById('createResourceView_IBMStorage').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_IBMStorage" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_IBMStorage;
CreateResourceView_IBMStorage.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_IBMStorage)
