...
var MonitoringSettingTab = require('./createResourceView_Netscreen_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Netscreen = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Netscreen') != null) {
            document.getElementById('createResourceView_Netscreen').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Netscreen" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Netscreen;
CreateResourceView_Netscreen.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Netscreen)
