...
var MonitoringSettingTab = require('./createResourceView_DNS_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_DNS = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_DNS') != null) {
            document.getElementById('createResourceView_DNS').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_DNS" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_DNS;
CreateResourceView_DNS.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_DNS)
