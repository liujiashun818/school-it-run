...
var MonitoringSettingTab = require('./createResourceView_Weblogic_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Weblogic = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Weblogic') != null) {
            document.getElementById('createResourceView_Weblogic').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Weblogic" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Weblogic;
CreateResourceView_Weblogic.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Weblogic)
