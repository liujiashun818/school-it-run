...
var MonitoringSettingTab = require('./createResourceView_Mail_monitoringSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_Mail = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_Mail') != null) {
            document.getElementById('createResourceView_Mail').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_Mail" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_Mail;
CreateResourceView_Mail.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_Mail)
