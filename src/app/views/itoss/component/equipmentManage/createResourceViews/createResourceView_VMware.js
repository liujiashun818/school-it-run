...
var MonitoringSettingTab = require('./createResourceView_VMware_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_VMware = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_VMware') != null) {
            document.getElementById('createResourceView_VMware').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_VMware" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_VMware;
CreateResourceView_VMware.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_VMware)
