...
var MonitoringSettingTab = require('./createResourceView_DME3000_monitoringSettingTab');
var AssetSettingTab = require('./common/createResourceView_assetSettingTab');

globalizeLocalizer(Globalize);

var CreateResourceView_DME3000 = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createResourceView_DME3000') != null) {
            document.getElementById('createResourceView_DME3000').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        return (
            <div id="createResourceView_DME3000" className="overviewDesViewDiv operationButtons">
...
// module.exports = CreateResourceView_DME3000;
CreateResourceView_DME3000.propTypes = {
...
export default connect(mapStateToProps)(CreateResourceView_DME3000)
