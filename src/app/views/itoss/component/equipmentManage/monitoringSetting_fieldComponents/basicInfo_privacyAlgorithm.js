...
var BasicInfo_privacyAlgorithm = React.createClass({
    render:function(){
        return(
            <div className={'contentTabDiv col-md-3 ' + (this.props.paddingLeft?'ContentTabRightDiv':'')} >
                <p className="help-block">隐私算法{this.props.required?<span style={{color: "red"}}>*</span>:''}&nbsp;&nbsp;<i title ="隐私算法" className="fa fa-question-circle fa-lg"></i></p>
...
module.exports = BasicInfo_privacyAlgorithm;
