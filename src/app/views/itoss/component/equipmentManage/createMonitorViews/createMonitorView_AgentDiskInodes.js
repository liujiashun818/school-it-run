...
var CreateMonitorView_AgentDiskInodes = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentDiskInodes') != null) {
            document.getElementById('createMonitorView_AgentDiskInodes').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentDiskInodes" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentDiskInodes;
CreateMonitorView_AgentDiskInodes.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentDiskInodes)
