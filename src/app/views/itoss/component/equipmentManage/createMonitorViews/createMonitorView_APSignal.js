...
var CreateMonitorView_APSignal = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_APSignal') != null) {
            document.getElementById('createMonitorView_APSignal').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_APSignal" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_APSignal;
CreateMonitorView_APSignal.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_APSignal)
