...
var MonitorNetworkTableModal = React.createClass({
    ...
    componentDidMount: function() {
        $('#monitorNetworkTable').bootstrapTable({
            columns: [
                {
                    field: 'state',
                    radio: true
        ...
        var _this = this;
        $('#monitorNetworkTableModal').on('show.bs.modal', function () {
            $('#monitorNetworkTable').bootstrapTable('resetView');
            $('#monitorNetworkTable').bootstrapTable('refreshOptions', {data: _this.props.monitorNetworks});
        });
    },

    componentDidUpdate:function(){
        $('#monitorNetworkTable').bootstrapTable('refreshOptions', {data: this.props.monitorNetworks});
    },

    _handleOnClickOK: function() {
        var selectedNetwork = $('#monitorNetworkTable').bootstrapTable('getSelections');
    ...
    render : function(){
        return (
            <div className="modal fade" id="monitorNetworkTableModal" tabIndex="-1" role="dialog" aria-labelledby="monitorNetworkTableModalLabel" aria-hidden="true">
...
module.exports = MonitorNetworkTableModal;
