...
var CreateMonitorView_APCurrentChannel = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_APCurrentChannel') != null) {
            document.getElementById('createMonitorView_APCurrentChannel').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_APCurrentChannel" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_APCurrentChannel;
CreateMonitorView_APCurrentChannel.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_APCurrentChannel)
