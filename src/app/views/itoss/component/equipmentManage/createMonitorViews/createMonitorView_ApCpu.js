...
var CreateMonitorView_ApCpu = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_ApCpu') != null) {
            document.getElementById('createMonitorView_ApCpu').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_ApCpu" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_ApCpu;
CreateMonitorView_ApCpu.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_ApCpu)
