...
var CreateMonitorView_APBearingUser = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_APBearingUser') != null) {
            document.getElementById('createMonitorView_APBearingUser').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_APBearingUser" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_APBearingUser;
CreateMonitorView_APBearingUser.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_APBearingUser)
