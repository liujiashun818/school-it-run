...
var CreateMonitorView_AgentService = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentService') != null) {
            document.getElementById('createMonitorView_AgentService').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentService" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentService;
CreateMonitorView_AgentService.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentService)
