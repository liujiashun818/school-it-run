...
var CreateMonitorView_WeblogicExecuteQueue = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WeblogicExecuteQueue') != null) {
            document.getElementById('createMonitorView_WeblogicExecuteQueue').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WeblogicExecuteQueue" className="overviewDesViewDiv monitoringSettingTab operationButtons">
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td className="paddingleft10" style={{width:"15%"}}>队列名称<span style={{color: "red"}}>*</span></td>
...
// module.exports = CreateMonitorView_WeblogicExecuteQueue;
CreateMonitorView_WeblogicExecuteQueue.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WeblogicExecuteQueue)
