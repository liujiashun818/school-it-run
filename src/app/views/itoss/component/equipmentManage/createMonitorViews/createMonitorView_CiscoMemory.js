...
var CreateMonitorView_CiscoMemory = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_CiscoMemory') != null) {
            document.getElementById('createMonitorView_CiscoMemory').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_CiscoMemory" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_CiscoMemory;
CreateMonitorView_CiscoMemory.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_CiscoMemory)
