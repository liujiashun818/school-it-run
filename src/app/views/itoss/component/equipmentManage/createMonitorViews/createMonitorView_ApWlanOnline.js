...
var CreateMonitorView_ApWlanOnline = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_ApWlanOnline') != null) {
            document.getElementById('createMonitorView_ApWlanOnline').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_ApWlanOnline" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_ApWlanOnline;
CreateMonitorView_ApWlanOnline.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_ApWlanOnline)
