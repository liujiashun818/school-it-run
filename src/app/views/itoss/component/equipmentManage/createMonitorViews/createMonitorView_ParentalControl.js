...
var CreateMonitorView_ParentalControl = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_ParentalControl') != null) {
            document.getElementById('createMonitorView_ParentalControl').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_ParentalControl" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_ParentalControl;
CreateMonitorView_ParentalControl.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_ParentalControl)
