...
var CreateMonitorView_Ftp = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_Ftp') != null) {
            document.getElementById('createMonitorView_Ftp').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_Ftp" className="overviewDesViewDiv monitoringSettingTab operationButtons">
                      ...
                      <table>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="paddingleft10" style={{width:"15%"}}>文件名<span style={{color: "red"}}>*</span></td>
                            <td colSpan="2" style={{width:"30%"}}><input type="text"/></td>
                          </tr>

                          <tr>
                            <th rowSpan="5" style={{width:"10%"}}>高级选项</th>
                            <td className="paddingleft10" style={{width:"15%"}}>模式</td>
                            <td colSpan="2" style={{width:"30%"}}>
                                <label style={{marginBottom:"0",paddingLeft:"5px"}}>
                                    <input type="checkbox" className="input-checkbox"/>被动模式
                                </label>
                            </td>
                            <td className="paddingleft10" style={{width:"15%"}}>连接超时</td>
                          ...
                          <tr>
                            ...
                            <td style={{width:"75%"}}><ReactWidgets.DropdownList data={taskSchedulerData} defaultValue={taskSchedulerData[0]} textField='name'/></td>
                          </tr>
                          <tr>
...
// module.exports = CreateMonitorView_Ftp;
CreateMonitorView_Ftp.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_Ftp)
