...
var CreateMonitorView_Agent = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_Agent') != null) {
            document.getElementById('createMonitorView_Agent').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_Agent" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_Agent;
CreateMonitorView_Agent.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_Agent)
