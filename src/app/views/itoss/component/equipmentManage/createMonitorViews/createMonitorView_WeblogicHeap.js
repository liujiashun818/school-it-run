...
var CreateMonitorView_WeblogicHeap = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WeblogicHeap') != null) {
            document.getElementById('createMonitorView_WeblogicHeap').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WeblogicHeap" className="overviewDesViewDiv monitoringSettingTab operationButtons">
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td className="paddingleft10" style={{width:"15%"}}>名称<span style={{color: "red"}}>*</span></td>
...
// module.exports = CreateMonitorView_WeblogicHeap;
CreateMonitorView_WeblogicHeap.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WeblogicHeap)
