...
var CreateMonitorView_AgentDirectory = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentDirectory') != null) {
            document.getElementById('createMonitorView_AgentDirectory').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentDirectory" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentDirectory;
CreateMonitorView_AgentDirectory.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentDirectory)
