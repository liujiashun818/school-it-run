...
var CreateMonitorView_APPercentage = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_APPercentage') != null) {
            document.getElementById('createMonitorView_APPercentage').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_APPercentage" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_APPercentage;
CreateMonitorView_APPercentage.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_APPercentage)
