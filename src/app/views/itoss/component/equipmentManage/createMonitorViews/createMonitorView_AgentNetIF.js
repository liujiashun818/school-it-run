...
var CreateMonitorView_AgentNetIF = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentNetIF') != null) {
            document.getElementById('createMonitorView_AgentNetIF').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentNetIF" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentNetIF;
CreateMonitorView_AgentNetIF.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentNetIF)
