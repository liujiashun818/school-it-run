...
var CreateMonitorView_WeblogicCluster = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WeblogicCluster') != null) {
            document.getElementById('createMonitorView_WeblogicCluster').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WeblogicCluster" className="overviewDesViewDiv monitoringSettingTab operationButtons">
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td className="paddingleft10" style={{width:"15%"}}>Cluster名称<span style={{color: "red"}}>*</span></td>
...
// module.exports = CreateMonitorView_WeblogicCluster;
CreateMonitorView_WeblogicCluster.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WeblogicCluster)
