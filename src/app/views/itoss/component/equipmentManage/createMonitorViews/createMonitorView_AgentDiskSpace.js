...
var CreateMonitorView_AgentDiskSpace = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentDiskSpace') != null) {
            document.getElementById('createMonitorView_AgentDiskSpace').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentDiskSpace" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentDiskSpace;
CreateMonitorView_AgentDiskSpace.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentDiskSpace)
