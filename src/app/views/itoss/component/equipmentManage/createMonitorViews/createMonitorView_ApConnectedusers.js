...
var CreateMonitorView_ApConnectedusers = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_ApConnectedusers') != null) {
            document.getElementById('createMonitorView_ApConnectedusers').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_ApConnectedusers" className="overviewDesViewDiv monitoringSettingTab operationButtons">
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td className="paddingleft10" style={{width:"15%"}}>选择AP<span style={{color: "red"}}>*</span></td>
                            ...
                            <td colSpan="2" style={{width:"75%"}}><input type="text"/></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td colSpan="2" style={{width:"30%"}}><ReactWidgets.DropdownList data={taskSchedulerData} defaultValue={taskSchedulerData[0]} textField='name'/></td>
                          </tr>
                          <tr>
...
// module.exports = CreateMonitorView_ApConnectedusers;
CreateMonitorView_ApConnectedusers.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_ApConnectedusers)
