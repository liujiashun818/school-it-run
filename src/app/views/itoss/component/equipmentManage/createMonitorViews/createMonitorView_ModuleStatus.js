...
var CreateMonitorView_ModuleStatus = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_ModuleStatus') != null) {
            document.getElementById('createMonitorView_ModuleStatus').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_ModuleStatus" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_ModuleStatus;
CreateMonitorView_ModuleStatus.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_ModuleStatus)
