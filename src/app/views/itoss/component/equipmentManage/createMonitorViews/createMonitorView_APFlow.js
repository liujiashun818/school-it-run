...
var CreateMonitorView_APFlow = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_APFlow') != null) {
            document.getElementById('createMonitorView_APFlow').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_APFlow" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_APFlow;
CreateMonitorView_APFlow.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_APFlow)
