...
var CreateMonitorView_OnlineStatus = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_OnlineStatus') != null) {
            document.getElementById('createMonitorView_OnlineStatus').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_OnlineStatus" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_OnlineStatus;
CreateMonitorView_OnlineStatus.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_OnlineStatus)
