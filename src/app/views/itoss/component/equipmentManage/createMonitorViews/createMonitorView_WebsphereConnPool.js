...
var CreateMonitorView_WebsphereConnPool = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WebsphereConnPool') != null) {
            document.getElementById('createMonitorView_WebsphereConnPool').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WebsphereConnPool" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_WebsphereConnPool;
CreateMonitorView_WebsphereConnPool.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WebsphereConnPool)
