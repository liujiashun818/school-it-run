...
var CreateMonitorView_AgentDiskIO = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentDiskIO') != null) {
            document.getElementById('createMonitorView_AgentDiskIO').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentDiskIO" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentDiskIO;
CreateMonitorView_AgentDiskIO.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentDiskIO)
