...
var CreateMonitorView_ConnectionsNumber = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_ConnectionsNumber') != null) {
            document.getElementById('createMonitorView_ConnectionsNumber').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_ConnectionsNumber" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_ConnectionsNumber;
CreateMonitorView_ConnectionsNumber.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_ConnectionsNumber)
