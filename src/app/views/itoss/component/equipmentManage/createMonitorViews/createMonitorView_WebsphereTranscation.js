...
var CreateMonitorView_WebsphereTranscation = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WebsphereTranscation') != null) {
            document.getElementById('createMonitorView_WebsphereTranscation').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WebsphereTranscation" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_WebsphereTranscation;
CreateMonitorView_WebsphereTranscation.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WebsphereTranscation)
