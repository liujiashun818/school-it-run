...
var CreateMonitorView_AgentScript = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentScript') != null) {
            document.getElementById('createMonitorView_AgentScript').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentScript" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentScript;
CreateMonitorView_AgentScript.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentScript)
