...
var CreateMonitorView_WeblogicJms = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WeblogicJms') != null) {
            document.getElementById('createMonitorView_WeblogicJms').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WeblogicJms" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_Jms;
CreateMonitorView_WeblogicJms.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WeblogicJms)
