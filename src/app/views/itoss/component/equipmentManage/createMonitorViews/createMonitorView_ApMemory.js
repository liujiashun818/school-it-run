...
var CreateMonitorView_ApMemory = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_ApMemory') != null) {
            document.getElementById('createMonitorView_ApMemory').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_ApMemory" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_ApMemory;
CreateMonitorView_ApMemory.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_ApMemory)
