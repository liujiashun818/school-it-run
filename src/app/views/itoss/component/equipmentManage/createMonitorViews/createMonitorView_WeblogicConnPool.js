...
var CreateMonitorView_WeblogicConnPool = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WeblogicConnPool') != null) {
            document.getElementById('createMonitorView_WeblogicConnPool').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WeblogicConnPool" className="overviewDesViewDiv monitoringSettingTab operationButtons">
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td className="paddingleft10" style={{width:"15%"}}>连接池名称<span style={{color: "red"}}>*</span></td>
...
// module.exports = CreateMonitorView_WeblogicConnPool;
CreateMonitorView_WeblogicConnPool.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WeblogicConnPool)
