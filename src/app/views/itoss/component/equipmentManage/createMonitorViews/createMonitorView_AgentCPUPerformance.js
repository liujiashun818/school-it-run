...
var CreateMonitorView_AgentCPUPerformance = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentCPUPerformance') != null) {
            document.getElementById('createMonitorView_AgentCPUPerformance').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentCPUPerformance" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentCPUPerformance;
CreateMonitorView_AgentCPUPerformance.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentCPUPerformance)
