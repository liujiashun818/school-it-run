...
var CreateMonitorView_AgentMemory = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentMemory') != null) {
            document.getElementById('createMonitorView_AgentMemory').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentMemory" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentMemory;
CreateMonitorView_AgentMemory.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentMemory)
