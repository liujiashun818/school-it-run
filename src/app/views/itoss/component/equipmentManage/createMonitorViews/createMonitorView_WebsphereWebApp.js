...
var CreateMonitorView_WebsphereWebApp = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WebsphereWebApp') != null) {
            document.getElementById('createMonitorView_WebsphereWebApp').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WebsphereWebApp" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_WebsphereWebApp;
CreateMonitorView_WebsphereWebApp.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WebsphereWebApp)
