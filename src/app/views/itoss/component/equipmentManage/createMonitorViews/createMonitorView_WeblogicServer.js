...
var CreateMonitorView_WeblogicServer = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WeblogicServer') != null) {
            document.getElementById('createMonitorView_WeblogicServer').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WeblogicServer" className="overviewDesViewDiv monitoringSettingTab operationButtons">
                      ...
                      <table>
                        <tbody>
                          <tr>
                            ...
                            <td className="paddingleft10" style={{width:"15%"}}>服务名称<span style={{color: "red"}}>*</span></td>
...
// module.exports = CreateMonitorView_Server;
CreateMonitorView_WeblogicServer.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WeblogicServer)
