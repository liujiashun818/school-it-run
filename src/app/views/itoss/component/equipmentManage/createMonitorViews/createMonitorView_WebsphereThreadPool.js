...
var CreateMonitorView_WebsphereThreadPool = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WebsphereThreadPool') != null) {
            document.getElementById('createMonitorView_WebsphereThreadPool').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WebsphereThreadPool" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_WebsphereThreadPool;
CreateMonitorView_WebsphereThreadPool.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WebsphereThreadPool)
