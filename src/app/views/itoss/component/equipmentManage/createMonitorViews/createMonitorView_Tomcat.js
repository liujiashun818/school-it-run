...
var CreateMonitorView_Tomcat = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_Tomcat') != null) {
            document.getElementById('createMonitorView_Tomcat').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_Tomcat" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_Tomcat;
CreateMonitorView_Tomcat.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_Tomcat)
