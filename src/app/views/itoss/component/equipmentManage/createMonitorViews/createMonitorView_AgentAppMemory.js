...
var CreateMonitorView_AgentAppMemory = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentAppMemory') != null) {
            document.getElementById('createMonitorView_AgentAppMemory').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentAppMemory" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentAppMemory;
CreateMonitorView_AgentAppMemory.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentAppMemory)
