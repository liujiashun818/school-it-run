...
var CreateMonitorView_WebsphereJVM = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WebsphereJVM') != null) {
            document.getElementById('createMonitorView_WebsphereJVM').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WebsphereJVM" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_WebsphereJVM;
CreateMonitorView_WebsphereJVM.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WebsphereJVM)
