...
var CreateMonitorView_CiscoCpu = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_CiscoCpu') != null) {
            document.getElementById('createMonitorView_CiscoCpu').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_CiscoCpu" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_CiscoCpu;
CreateMonitorView_CiscoCpu.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_CiscoCpu)
