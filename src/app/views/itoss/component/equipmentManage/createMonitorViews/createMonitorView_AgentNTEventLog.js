...
var CreateMonitorView_AgentNTEventLog = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentNTEventLog') != null) {
            document.getElementById('createMonitorView_AgentNTEventLog').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentNTEventLog" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentNTEventLog;
CreateMonitorView_AgentNTEventLog.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentNTEventLog)
