...
var CreateMonitorView_WeblogicStatus = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WeblogicStatus') != null) {
            document.getElementById('createMonitorView_WeblogicStatus').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WeblogicStatus" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
CreateMonitorView_WeblogicStatus.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WeblogicStatus)
