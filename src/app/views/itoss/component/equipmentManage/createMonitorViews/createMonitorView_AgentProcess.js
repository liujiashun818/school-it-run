...
var CreateMonitorView_AgentProcess = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentProcess') != null) {
            document.getElementById('createMonitorView_AgentProcess').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentProcess" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentProcess;
CreateMonitorView_AgentProcess.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentProcess)
