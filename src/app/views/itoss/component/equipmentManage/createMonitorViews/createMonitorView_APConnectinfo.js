...
var CreateMonitorView_APConnectinfo = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_APConnectinfo') != null) {
            document.getElementById('createMonitorView_APConnectinfo').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_APConnectinfo" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_APConnectinfo;
CreateMonitorView_APConnectinfo.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_APConnectinfo)
