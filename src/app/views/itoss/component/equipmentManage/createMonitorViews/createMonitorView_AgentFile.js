...
var CreateMonitorView_AgentFile = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentFile') != null) {
            document.getElementById('createMonitorView_AgentFile').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentFile" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentFile;
CreateMonitorView_AgentFile.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentFile)
