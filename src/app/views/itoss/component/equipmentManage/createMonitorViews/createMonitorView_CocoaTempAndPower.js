...
var CreateMonitorView_CocoaTempAndPower = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_CocoaTempAndPower') != null) {
            document.getElementById('createMonitorView_CocoaTempAndPower').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_CocoaTempAndPower" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_CocoaTempAndPower;
CreateMonitorView_CocoaTempAndPower.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_CocoaTempAndPower)
