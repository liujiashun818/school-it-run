...
var CreateMonitorView_WebsphereServSession = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_WebsphereServSession') != null) {
            document.getElementById('createMonitorView_WebsphereServSession').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_WebsphereServSession" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_WebsphereServSession;
CreateMonitorView_WebsphereServSession.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_WebsphereServSession)
