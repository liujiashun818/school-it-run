...
var CreateMonitorView_APFaultRate = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_APFaultRate') != null) {
            document.getElementById('createMonitorView_APFaultRate').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_APFaultRate" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_APFaultRate;
CreateMonitorView_APFaultRate.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_APFaultRate)
