...
var CreateMonitorView_AgentCPU = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_AgentCPU') != null) {
            document.getElementById('createMonitorView_AgentCPU').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_AgentCPU" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_AgentCPU;
CreateMonitorView_AgentCPU.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_AgentCPU)
