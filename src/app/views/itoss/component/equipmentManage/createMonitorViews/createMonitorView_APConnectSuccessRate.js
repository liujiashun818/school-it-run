...
var CreateMonitorView_APConnectSuccessRate = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
        if(document.getElementById('createMonitorView_APConnectSuccessRate') != null) {
            document.getElementById('createMonitorView_APConnectSuccessRate').style.height = $(window).height() - 110 - 30 + 'px';
        }
    },
    ...
    render: function() {
        ...
        return (
            <div id="createMonitorView_APConnectSuccessRate" className="overviewDesViewDiv monitoringSettingTab operationButtons">
...
// module.exports = CreateMonitorView_APConnectSuccessRate;
CreateMonitorView_APConnectSuccessRate.propTypes = {
...
export default connect(mapStateToProps)(CreateMonitorView_APConnectSuccessRate)
