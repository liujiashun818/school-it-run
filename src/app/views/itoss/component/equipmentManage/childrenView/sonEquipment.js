...
function tableResetView() {
  var tbl = document.getElementById('sonEquipmentTable');
...
var SonEquipment = React.createClass({
    ...
    componentDidMount: function() {
      var that = this;
        $('#sonEquipmentTable').bootstrapTable({
            columns: [
                {
                    field: 'state',
                    checkbox: true
        ...
        tableResetView();
        $('#sonEquipmentTable').on('reset-view.bs.table', function (){
          tableResetView();
        });
    },
    //getHeight: function() {
    ...
    render: function() {
        return (
            <div className='hardwareAssetTableBox equipmentManageTable'>
                <div id='sonEquipmentTable-toolbar'>
                ...
                <table id='sonEquipmentTable'
                       data-toggle='table'
                       data-classes='table table-no-bordered table-hover'
                       data-height={285}
                       data-toolbar='#sonEquipmentTable-toolbar'
