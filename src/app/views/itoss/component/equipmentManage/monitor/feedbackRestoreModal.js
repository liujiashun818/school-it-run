...
var FeedbackRestoreModal = React.createClass({
    ...
    _handleOnClickOK: function() {
        const { monitorTableSelectedRowData, setUserFeedbackReset } = this.props;
        var param = {};
        ...
        $('#feedbackRestoreModal').modal('hide');
        $('#feedbackModal').modal('hide');
    },

    render : function(){
        return (
            <div className="modal fade" id="feedbackRestoreModal" tabIndex="-1" role="dialog" aria-labelledby="feedbackRestoreModalLabel" aria-hidden="true">
