...
var Createview_desView_assetTabs = React.createClass({
    ...
    componentDidMount: function(){
        var creator_input = $("#assetTabs-creator").find("input");
                    ...
                    <div className="table-basic-h3 block-content width7 no-bottom-border">
                        <div className="table-basic-h2 width3">
                            ...
                            <div className="table-basic-h1-input width4" id="assetTabs-assetType">
                                <ReactWidgets.DropdownList tabIndex="4" className='form-control dropdownStyle width8' data={this.props.AssetTypeList} textField='name' valueComponent={AssetTypeInput} />
                            </div>
                        </div>
                        <div className="table-basic-h2 width3">
                        ...
                        <div className="table-basic-h2 width3">
                            ...
                            <div className="table-basic-h1-input width4 no-right-border" id="assetTabs-area">
                                <ReactWidgets.DropdownList tabIndex="3" className='form-control dropdownStyle width8' data={this.props.AreaIdList} textField='name' valueComponent={AreaValueInput} />
                            </div>
                    ...
                    <div className="table-basic-h3 block-content width7 no-bottom-border">
                        ...
                        <div className="table-basic-h2 width3">
                            ...
                            <div className="table-basic-h1-input width4" id="assetTabs-createTime">
                                <ReactWidgets.DateTimePicker tabIndex="9" className='dateTimePickerStyle full-width width8' format={"yyyy-MM-dd"} time={false}defaultValue={new Date()} />
                            </div>
