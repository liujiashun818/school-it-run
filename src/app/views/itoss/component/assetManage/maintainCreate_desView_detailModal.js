/**
 * Created by Yuchen on 2016/01/14.
 * 新建维修单-资产信息表格
 */
...
var AssetTableModal = React.createClass({
    ...
    componentDidMount: function(){
        ...
        $("#assetModal-detail").on('show.bs.modal', function(e){
            _this.props.get_create_data({callback:function(resp1){
                ...
                <div className="modal-dialog assetTableModalDialog assetModalDialog" style={{width:"80%",height:"332px"}}>
                    <div className="modal-content" style={{height:"100%"}}>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-default btn-sm modalFootBtn" onClick={this._handleOnClick} style={{width:84}}>进入详情页</button>
