...
var NoticeApprovalTable = React.createClass({
    mixins: [History],
    ...
    componentDidMount: function() {
      ...
      dispatch(queryNotice(updateObj));
        ...
        // var noticeLimitObj;
        // if(noticeLimitObj.noticeApprovalDelete){
        //   this.createDeleteBtn();
        // }
    },
    componentDidUpdate:function(){
      ...
      //   if(quxianLimit.noticeApprovalDelete){
      //     this.createDeleteBtn();
      //   }
      // }
    },
    ...
    navigateToDetail: function(row, element) {
      ...
      // var beforeNode = zTree.getNodeByParam("name","审核公告");
      // var targetNode = zTree.getNodeByParam("name","审核公告");
      ...
      this.props.setCurName("审核公告");
      this.history.pushState(null,'baseManage/noticeApprovalDetails');
    },
...
export default connect(mapNoticeApproval)(NoticeApprovalTable);

// module.exports = NoticeApprovalTable;
