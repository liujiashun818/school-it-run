...
window.dataDictTable12Event = {
  'click .dataDictTable1Edit':function(e, value, row, index){
    ...
    $("#tpDescInput").val(desc);
    _this.props.setTpId(id);
  },
  'click .dataDictTable1Delete':function(e, value, row, index){
    ...
    _this.props.setTpId(id);
    // var id = row.RecId;
    // _this.getFlux().actions.DictActions.set_curStatuId(id);
...
var dataDictRightView = React.createClass({
    ...
    componentDidUpdate:function(){
      var bdata = this.props.tpData;
      $("#dataDictRightTable12").bootstrapTable("load",bdata);
    },
    componentDidMount:function(){
      $('#dataDictRightTable12').bootstrapTable({
        columns: [
          {
            title: '导航名称',
            field: 'DictDataName',
          ...
          <div className="col-md-12">
            <div className="col-md-6">
              <div className="input-group">
                <span className="input-group-addon">导航名称<span style={{"color":"#FF0000"}}>*</span></span>
                <input type="text" className="form-control" placeholder="导航名称" id="tpNameInput"/>
              </div>
            </div>
            <div className="col-md-6">
              <div className="input-group">
                <span className="input-group-addon">导航值<span style={{"color":"#FF0000"}}>*</span></span>
                <input type="text" className="form-control" placeholder="导航值" id="tpValueInput"/>
              </div>
            </div>
            <div className="col-md-12">
              <textarea className="form-control" id="tpDescInput" placeholder="导航描述"></textarea>
            </div>
          </div>
          <div className="col-md-12">
            <table id="dataDictRightTable12"
                   data-toggle='table'
                   data-search='true'
