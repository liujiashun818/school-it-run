...
var dataDictRightView = React.createClass({
    ...
    componentDidUpdate:function(){
      var bdata = this.props.workOrderStatusData;
      $("#dataDictRightTable14").bootstrapTable("load",bdata);
    },
    componentDidMount:function(){
      $('#dataDictRightTable14').bootstrapTable({
        columns: [
          {
            title: '工单名称',
            field: 'DictDataName',
    ...
    deleteData:function(){
      this.props.delete_workOrderStatusData();
