...
var EquipmentListPage = React.createClass({
    ...
    render: function() {
        return (
            ...
            //        mainContent = {<HomePage flux={this.props.flux} dataset={this.state.originDataset} update={this.update} pageId={50}/>}
            //        sidebarContent = {<PortalPage flux={this.props.flux} datasetCollection={this.state.newDatasetCollection} update={this.update}/>}>
            //    </SideBar>
            //</div>
            <HomePage flux={this.props.flux} pageId={50}/>
        );
    },
...
module.exports = EquipmentListPage;
